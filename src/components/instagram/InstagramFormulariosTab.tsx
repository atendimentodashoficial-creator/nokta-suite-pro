...
import InstagramFormularioDialog from "./formularios/InstagramFormularioDialog";
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Capture dados dos seus leads via Instagram</p>
          </div>
