    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <Input
              value={formData.form_base_url}
              onChange={(e) => setFormData({ ...formData, form_base_url: e.target.value })}
            />
            <Button
              type="button"
              variant="outline"
              onClick={() => setFormData({ ...formData, form_base_url: window.location.origin })}
            >
              Usar URL atual
            </Button>
          </div>
