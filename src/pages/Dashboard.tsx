...
export default function Dashboard() {
  ...
  // === AGENDAMENTOS REALIZADOS = Registrados - Não Compareceu ===
  ...
  const numeroAgendamentosRealizados = numeroAgendamentosRegistrados - agendamentosRegistradosNaoCompareceu;
